...
final class Utils {
    ...
    static RuntimeException exception(String message, Object... arguments) {
        String finalMessage = addLogId(String.format(message, arguments));
        Utils.error(LOGGER, finalMessage);
    ...
    static RuntimeException exception(Exception exception, String message, Object... arguments) {
        String finalMessage = addLogId(String.format(message, arguments));
        Utils.error(LOGGER, exception, finalMessage);
    ...
    static void updateLogId(String logId) {
        LOG_ID.set(logId);
    }

    static void error(Log logger, String message, Object... arguments) {
        if (logger.isErrorEnabled()) {
            logger.error(addLogId(String.format(message, arguments)));
        }
    }

    static void error(Log logger, Exception exception, String message, Object... arguments) {
        if (logger.isErrorEnabled()) {
            logger.error(addLogId(String.format(message, arguments)), exception);
        }
    }

    static void warn(Log logger, String message, Object... arguments) {
        if (logger.isErrorEnabled()) {
            logger.warn(addLogId(String.format(message, arguments)));
        }
    }

    static void debug(Log logger, String message, Object... arguments) {
        if (logger.isDebugEnabled()) {
            logger.debug(addLogId(String.format(message, arguments)));
        }
    }

    static void info(Log logger, String message, Object... arguments) {
        if (logger.isInfoEnabled()) {
            logger.info(addLogId(String.format(message, arguments)));
        }
    }
    ...
    private static String addLogId(String message) {
        String logId = LOG_ID.get();
        return logId == null ? message : "[" + logId + "] " + message;
    }
}
