...
public final class FileManagerTest extends TestSupport {
    ...
    public void testGetLayerAssociatedFilesWithMultipleLevels() throws Exception {
        String pathTemplate = Utils.buildPath("tiles", "{format}", "{style}", "zoom-{z}", "{layer}", "ranges-{x}-{y}.sqlite");
        File fileAsiaA = createFileInRootDir(Utils.buildPath("tiles", "png", "default", "zoom-10", "asia", "ranges-0-500.sqlite"));
        File fileAsiaB = createFileInRootDir(Utils.buildPath("tiles", "png", "default", "zoom-11", "asia", "ranges-100-500.sqlite"));
        File fileAsiaC = createFileInRootDir(Utils.buildPath("tiles", "png", "dark-borders", "zoom-10", "asia", "ranges-0-500.sqlite"));
        File fileAsiaD = createFileInRootDir(Utils.buildPath("tiles", "jpeg", "dark-borders", "zoom-10", "asia", "ranges-0-500.sqlite"));
        File fileAfricaA = createFileInRootDir(Utils.buildPath("tiles", "png", "default", "zoom-10", "africa", "ranges-0-500.sqlite"));
        File fileAmericaA = createFileInRootDir(Utils.buildPath("tiles", "png", "dark-borders", "zoom-10", "america", "ranges-0-500.sqlite"));
        File fileAmericaB = createFileInRootDir(Utils.buildPath("tiles", "jpeg", "dark-borders", "zoom-10", "america", "ranges-0-500.sqlite"));
        File fileEuropeA = createFileInRootDir(Utils.buildPath("tiles", "gif", "dark-borders", "zoom-15", "europe", "ranges-4000-500.sqlite"));
    ...
    public void testGetGridSetAndLayerAssociatedFiles() throws Exception {
        String pathTemplate = Utils.buildPath("tiles", "{grid}", "{format}", "{style}", "zoom-{z}", "{layer}", "ranges-{x}-{y}.sqlite");
        File fileAsiaGrid1A = createFileInRootDir(Utils.buildPath("tiles", "grid1", "png", "default", "zoom-10", "asia", "ranges-0-500.sqlite"));
        File fileAsiaGrid2B = createFileInRootDir(Utils.buildPath("tiles", "grid2", "png", "default", "zoom-11", "asia", "ranges-100-500.sqlite"));
        File fileAsiaGrid3C = createFileInRootDir(Utils.buildPath("tiles", "grid3", "png", "dark-borders", "zoom-10", "asia", "ranges-0-500.sqlite"));
        File fileAsiaGrid3D = createFileInRootDir(Utils.buildPath("tiles", "grid3", "jpeg", "dark-borders", "zoom-10", "asia", "ranges-0-500.sqlite"));
        File fileAfricaGrid1A = createFileInRootDir(Utils.buildPath("tiles", "grid1", "png", "default", "zoom-10", "africa", "ranges-0-500.sqlite"));
        File fileAmericaGrid1A = createFileInRootDir(Utils.buildPath("tiles", "grid1", "png", "dark-borders", "zoom-10", "america", "ranges-0-500.sqlite"));
        File fileAmericaGrid2B = createFileInRootDir(Utils.buildPath("tiles", "grid2", "jpeg", "dark-borders", "zoom-10", "america", "ranges-0-500.sqlite"));
        File fileEuropeGrid1A = createFileInRootDir(Utils.buildPath("tiles", "grid1", "gif", "dark-borders", "zoom-15", "europe", "ranges-4000-500.sqlite"));
        FileManager fileManager = new FileManager(getRootDirectory(), pathTemplate, 500, 500);
    ...
    public void testSimplePathTemplate() throws Exception {
        genericTestPath(Utils.buildPath("tiles", "{grid}", "layers", "{layer}.sqlite"),
                Utils.buildPath("tiles", "wgs84", "layers", "europe.sqlite"),
                null, null, "europe", "wgs84", null);
    }

    @Test
    public void testPathTemplateWithRanges() throws Exception {
        genericTestPath(Utils.buildPath("{grid}", "tiles", "{layer}", "zoom-{z}", "ranges_{x}-{y}.sqlite"),
                Utils.buildPath("wgs84", "tiles", "usa", "zoom-15", "ranges_3000-1000.sqlite"),
                null, new long[]{3024, 1534, 15}, "usa", "wgs84", null);
    }

    @Test
    public void testPathTemplateWithParameters() throws Exception {
        genericTestPath(Utils.buildPath("{background}-tiles", "{grid}", "{layer}-{style}", "zoom-{z}", "ranges{x}{y}.sqlite"),
                Utils.buildPath("blue-tiles", "wgs84", "america-default", "zoom-15", "ranges30001000.sqlite"),
                null, new long[]{3024, 1534, 15}, "america", "wgs84", null,
                tuple("style", "default"), tuple("background", "blue"));
    }

    @Test
    public void testPathTemplateWithTileObject() throws Exception {
        TileObject tile = TileObject.createCompleteTileObject("africa", new long[]{7050, 5075, 11},
                "wgs84", "jpeg", tuplesToMap(tuple("style", "dark borders"), tuple("background", "blue")), null);
        String pathTemplate = Utils.buildPath("{format}-tiles", "{grid}", "{layer}-{style}", "zoom-{z}", "ranges-{x}_{y}.sqlite");
    ...
    public void testPathTemplateWithInvalidChars() throws Exception {
        genericTestPath(Utils.buildPath("{grid}", "{format}", "{layer}.sqlite"),
                Utils.buildPath("epsg_4326", "image_png", "europe_borders.sqlite"),
                null, null, "europe\\borders", "epsg:4326", "image/png");
    }
    ...
    public void testGetFilesByTileRange() throws Exception {
        ...
        TileRange tileRange = new TileRange("layer", "EPSG:4326", 5, 6, rangeBounds,
                MimeType.createFromExtension("png"), new HashMap<String, String>());
    ...
    private void checkFileExistsAndContainsTiles(Map<File, List<long[]>> files, File file,
                                                 long[]... expectedTiles) {
    ...
    @SafeVarargs
    private final void genericTestPath(String pathTemplate, String expectedPath, String parametersId,
                                       long[] xyz, String layerName, String gridSetId, String format, Tuple<String, String>... tuples) {
        genericTestPath(pathTemplate, expectedPath, parametersId, xyz, layerName, gridSetId, format, tuplesToMap(tuples));
    }

    private void genericTestPath(String pathTemplate, String expectedPath, String parametersId,
                                 long[] xyz, String layerName, String gridSetId, String format, Map<String, String> parameters) {
        FileManager fileManager = new FileManager(getRootDirectory(), pathTemplate, 1000, 1000);
