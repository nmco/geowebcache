...
public final class MbtilesBlobStoreTest extends TestSupport {
    ...
    public void testOpeningDatabaseFileWithMbtilesMetadata() throws Exception {
        ...
        File mbtilesMetadataFile = new File(mbtilesMetadataDirectory, "europe_asia.metadata");
        ...
        connectionManager.executeQuery(file, new SqliteConnectionManager.ResultExtractor<Object>() {
            @Override
